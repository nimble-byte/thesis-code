...
output_csv_path = os.path.join(os.getcwd(), "out/filtered_dataset.csv")
output_JSON_path = os.path.join(os.getcwd(), "out/filtered_dataset.json")
images_dir = os.path.join(os.getcwd(), "out/images")
